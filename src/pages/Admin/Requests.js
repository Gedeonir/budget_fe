    ...
    <AdminDashboard setUserData={setUserData}>
        ...
        <div className='w-full bg-primary2 rounded-lg py-4 px-2'>
            <div className='flex justify-between '>
                ...
                <div className='relative w-2/5 px-2'>
            ...
            <table border={10} cellSpacing={0} cellPadding={10} className='my-4 tex-md w-full py-4 text-text_primary text-left px-4'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <label className='bg-primary px-4 py-2 rounded-lg text-success font-bold'>
                                Approved
                            </label>
                        </td>
            ...
            <div className='flex justify-between gap-2'>
                <div className='flex justify-start items-center text-text_primary'>
